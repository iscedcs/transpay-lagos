...
export default function LivePaymentNotificationsAdminAccess() {
     const [cvofPaymentData, setcvofPaymentData] = useState<PaymentData | null>(null); // Initialize as null
    ...
    const [error, setError] = useState<string | null>(null);
     ...
     return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mx-auto">
