...
export const allUsers = async ({ page = 1, pageSize = 10, role }: AllUsersFetchParams) => {
...
export const allAgentsCreatedByAdminId = async ({ page = 1, pageSize = 10, adminId }: AllAgentsCreatedByAdminIdFetchParams) => {
     try {
          // Calculate the offset for pagination
          const skip = (page - 1) * pageSize;
