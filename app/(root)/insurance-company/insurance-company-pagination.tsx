...
interface InsuranceCompanyPaginationProps {
  currentPage: number
  totalPages: number
  totalCount: number
}

export function InsuranceCompanyPagination({ currentPage, totalPages, totalCount }: InsuranceCompanyPaginationProps) {
    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div className="flex items-center gap-2">
        <p className="text-sm text-muted-foreground">
          ...
          {Math.min(currentPage * Number(currentLimit), totalCount)} of {totalCount} claims
        </p>
      </div>
