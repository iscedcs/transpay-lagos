...
export function InsurancePagination({ currentPage, totalPages, totalCount }: InsurancePaginationProps) {
    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div className="flex items-center gap-2">
        <p className="text-sm text-muted-foreground">
          ...
          {Math.min(currentPage * Number(currentLimit), totalCount)} of {totalCount} vehicles
        </p>
      </div>
