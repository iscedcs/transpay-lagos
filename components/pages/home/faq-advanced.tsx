...
const faqData = {
  general: [
    {
      question: `What is LASITRAS?`,
      answer: `LASITRAS is a comprehensive transportation management platform designed specifically for Nigerian transportation authorities. It streamlines levy collection, enhances security, and provides real-time analytics for better decision-making.`,
    },
    {
      question: `How does LASITRAS differ from other solutions?`,
      answer: `Unlike traditional systems, LASITRAS is built specifically for the Nigerian transportation ecosystem. It offers seamless integration with existing infrastructure, supports multiple payment methods, and provides robust security features tailored to local needs.`,
    },
  ],
  security: [
    {
      question: `Is my data safe with your platform?`,
      answer: `Yes, your data is completely secure with LASITRAS. We implement military-grade encryption, regular security audits, and comply with all relevant data protection regulations. All sensitive information is encrypted both in transit and at rest.`,
    },
    {
  ...
  support: [
    ...
    },
    {
      ...
      answer: `Yes, our team of experts will guide you through the entire implementation process. We offer comprehensive training, system setup, and ongoing support to ensure a smooth transition to the LASITRAS platform.`,
    },
  ],
  pricing: [
    {
